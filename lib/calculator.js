...
// Handle backspace.
document.querySelector(".v p").addEventListener("click", function back() {
    let backSpace = output.innerHTML.substring(0, ((output.innerHTML).length - 1));
    output.innerHTML = backSpace;
})
